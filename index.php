...
<body data-page="home">
    <h1 class="hidden">Welcome to Jo Muncaster's Portfolio</h1>

    <!-- Main Nav -->

    <header id="main-nav" class="home-header">
    ...
    <!-- Video Player -->
        ...
        <div class="col-span-full">
            <section id="player-container" class="col-span-full">
                <h2 class="hidden">Video Player Section</h2>
                <video id="my-video" preload="metadata" poster="images/video_poster.jpg">
                    <source src="video/Jo_Muncaster_Demo_Reel.webm" type="video/webm">
